    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('single', 'Single'), ('married', 'Married'), ('divorced', 'Divorced'), ('widowed', 'Widowed'), ('seperated', 'Seperated')], default='other', max_length=20)),
                ...
                ('born_in', models.CharField(blank=True, max_length=200, null=True)),
                ('joined', models.DateTimeField(auto_now_add=True)),
                ('phone', models.CharField(blank=True, max_length=20, null=True)),
                ('dob', models.DateField(blank=True, null=True)),
                ('website', models.CharField(blank=True, max_length=20, null=True)),
                ('photos', models.ManyToManyField(blank=True, to='users.photo')),
